...
const AppleMiniLogo = (props: SVGAttributes<SVGSVGElement>) => {
  return (
    <svg
      {...props}
      width="22"
    ...
    >
      <g filter="url(#filter0_d_597_467)">
        <path
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_597_467"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_597_467"
            result="shape"
          />
        </filter>
      </defs>
